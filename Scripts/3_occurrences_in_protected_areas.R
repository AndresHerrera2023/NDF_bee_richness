...
#DRYFLOR occurrences:
occ_dryflor <- read.csv("./Data/STDF_bees_occ/dryflor/all/dryflor_bees_final_occ.csv")
occ_dryflor <- occ_dryflor[occ_dryflor$species != "sp",]
...
occ_teow <- read.csv("./Data/STDF_bees_occ/teow/all/teow_bees_final_occ.csv")
